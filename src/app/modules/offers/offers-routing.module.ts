...
const routes: Routes = [
    {
        ...
        children: [
            {path: '', component: OffersContainerComponent, data: {title: 'Find your next Offer here!'}},
            {path: 'my', component: OffersContainerComponent, data: {title: 'Your offers are listed here!', onlyMyOffers: true}},
            {path: 'new', component: OffersNewContainerComponent, data: {title: 'Create a new Offer!'}},
